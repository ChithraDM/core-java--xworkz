class PrinterTester{
    ...
    public static void main(String printer[]){
	  ...
	  Printer printer1 = new Printer("hp", "11 years", 6, "windows 10");
	  /*printer1.brand = "hp";
	  ...
	  Printer printer2 = new Printer("dell", "10 years", 9, "android 1.2");
	  /*printer2.brand = "dell";
	  ...
	  Printer printer3 = new Printer("asus", "12 years", 8, "windows 11");
	  /*printer3.brand = "asus";
	  ...
	  Printer printer4 = new Printer("asus vivobook", "9 years", 5, "android 1.8");
	  ...
	  Printer printer5 = new Printer("hp deskjet", "18 years", 10, "windows 9");
	  ...
	  Printer printer6 = new Printer("epson eco tank", "15 years", 9, "android lolipop");
	  /*printer6.brand = "epson eco tank";
	  printer6.warranty = "15 years";
	  printer6.itemWeightInKg = 9;
	  printer6.operatingSystem = "android lolipop";*/
	  ...
	  Printer printer7 = new Printer("canon", "6 years", 9, "android jellybean");
	  ...
	  Printer printer8 = new Printer("brother HL", "7 years", 19, "windows 8");
	  ...
	  Printer printer9 = new Printer("canon pixma", "9 years", 9, "android donut");
	  ...
	  Printer printer10 = new Printer("hp laser jet", "10 years", 10, "android vanilla");

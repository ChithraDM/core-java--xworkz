...
public static void main(String satellite[]){
	  ...
	  Satellite satellite1 = new Satellite("Sputnik 1", "communication", 15000);
	  ...
	  Satellite satellite2 = new Satellite("Cartosat-2A", "earth observation", 50000);
	  ...
	  Satellite satellite3 = new Satellite("Cartosat-2B", "navigation", 35000);
	  ...
	  Satellite satellite4 = new Satellite("IRNSS-1D", "astronomical", 95000);

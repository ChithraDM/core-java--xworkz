class ScreenProjectorTester{
  ...
  public static void main(String projector[]){
	  ...
	  ScreenProjector projector1 = new ScreenProjector("E Gate", "1 year", 4000, "navy blue");
	  ...
	  ScreenProjector projector2 = new ScreenProjector("Luminous", "2 years", 14000, "dark blue");
	  ...
	  ScreenProjector projector3 = new ScreenProjector("Philips", "4 years", 8000, "maroon");
	  ...
	  ScreenProjector projector4 = new ScreenProjector("Samsung", "1 year", 6000, "violet");
	  ...
	  ScreenProjector projector5 = new ScreenProjector("LG", "1/2 year", 3000, "purple");
	  /*projector5.brand = "LG";
	  ...
	  ScreenProjector projector6 = new ScreenProjector("Wipro", "5 years", 14000, "black");
	  ...
	  ScreenProjector projector7 = new ScreenProjector("Bosch", "4 years", 10000, "dark brown");
	  ...
	  ScreenProjector projector8 = new ScreenProjector("Whirlpool", "1 year", 5500, "grey");
	  ...
	  ScreenProjector projector9 = new ScreenProjector("Epson", "9 years", 80000, "dark pink");
	  ...
	  ScreenProjector projector10 = new ScreenProjector("Gate", "7 years", 40000, "red");

...
//biscuits-10
  static String biscuits[] = {"ParleG" , "Chaska maska" , "Tiger" , "Unibic" , "Goodday" , "Googly" , "Hide and seek" , "Britania Treat" , "Marigold" , "Sunfeast"};
//perfumes-10
static String perfumes[] = {"Lotus" , "Ajmal" , "Fogg" , "Eva" , "Axe" , "Tommy girl", "Shine" , "Engage" , "Mysore Sandal" , "Spinz"};
//groceries-10
  static String groceries[] = {"Rice" ,"Ragi" , "Moongdal" , "Green gram" , "Pepper" , "Sugar" , "Salt" , "Horse gram" , "Coffee powder" , "Sunpure oil"};
//cosmetics-25
  static String cosmetics[] = {"Sun screen" , "Primer" , "Eyeliner" , "Lipstick" , "Foundation" , "Moisturizer" , "Mascara" , "Eye shadow" , "Kajal" , "Concealer" , "Compact" , "Lip gloss" , "Nail polish" , "Blush" , "Lip Liner" , "Gel" , "Cream" , "Lotion" , "Lip balm" ,"Face powder" , "Highlighter" , "Nail polish remover" , "Nail extension" , "perfume" , "Toner"};

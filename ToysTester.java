...
public static void main(String play[]){
	  ...
	  Toys toys1 = new Toys("woody", "wooden", 400, "brown");
	  /*toys1.name = "woody";
	  toys1.type = "wooden";
	  toys1.price = 400;
	  toys1.color = "brown";*/
	  ...
	  Toys toys2 = new Toys("barbie", "plastic", 430, "pink");
	  /*toys2.name = "barbie";
	  toys2.type = "plastic";
	  toys2.price = 430;
	  toys2.color = "pink";*/
	  ...
	  Toys toys3 = new Toys("slinky dog", "plastic", 4500, "yellow");
	  ...
	  Toys toys4 = new Toys("doll", "cloth", 800, "gray");
	  /*toys4.name = "doll";
	  toys4.type = "cloth";
	  toys4.price = 800;
	  toys4.color = "gray";*/
	  ...
	  Toys toys5 = new Toys("teddy bear", "fabric", 600, "brown with red");
	  ...
	  Toys toys6 = new Toys("jessie", "cotton", 560, "black");
	  /*toys6.name = "jessie";
	  toys6.type = "cotton";
	  toys6.price = 560;
	  toys6.color = "black";*/
	  ...
	  Toys toys7 = new Toys("ball", "leather", 659, "blue");
	  /*toys7.name = "ball";
	  toys7.type = "leather";
	  toys7.price = 659;
	  toys7.color = "blue";*/
	  ...
	  Toys toys8 = new Toys("yoyo", "leather", 40, "green");
	  /*toys8.name = "yoyo";
	  toys8.type = "leather";
	  toys8.price = 40;
	  toys8.color = "green";*/
	  ...
	  Toys toys9 = new Toys("kite", "paper", 50, "parrot green");
	  /*toys9.name = "kite";
	  toys9.type = "paper";
	  toys9.price = 50;
	  ...
	  Toys toys10 = new Toys("lotso", "cotton", 700, "purple");
	  /*toys10.name = "lotso";
	  toys10.type = "cotton";
	  toys10.price = 700;
	  toys10.color = "purple";*/

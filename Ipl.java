...
//ex: for methods,using local variables and foreach  
 ...
 public static void main(String Cricketmania[]) {
	String batsMans[] = { "Sachin Tendulkar", "Virat Kohli", "Sourav Ganguli", "Rahul Dravid", "David Warner", "Ishan Kishan" , "Chris Gayle" , 
	"Mohammed Shami" , "Rashid khan" , "Mohit Sharma"};
    String iccTeamRankings[] = {"Australia", "Pakistan", "India", "Newzealand", "England", "South Africa", "Bangladesh", "Afghanistan", "Sri Lanka",
	"West Indies"};
    String iplTeamNames[] = {"Royal Challengers Bengaluru", "Chennai Super Kings","Kolkata Knight Riders", "Mumbai Indians", "Gujarat Titans", 
	"Rajastan Royals", "Sunrisers Hyderabad", "Delhi Capitals", "Lucknow Super Giants", "Punjab kings" };
 
	  System.out.println("Main started");
	  System.out.println("==========================");
	  //foreach
	  
	  getBatsMans(batsMans);
      ...
      public static void getBatsMans(String batsMans[]){

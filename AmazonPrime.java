...
class AmazonPrime{
	...
	static String kannadaMovies[]= {"K.G.F chapter1","K.G.F chapter2","A","Raaghu","Love Birds","Ravi Bopanna","Upendra Matte Baa",
	"Upendra","Uppi 2","Dia","Lucky Man","Lucky","U Turn","Kabzaa","H2O","Kalpana","Bharaate","Aishwarya","Love Moktail","Love Moktail 2",
	"Super","Buddhivantha","Law","Roberrt","Ninna Sanihake"};

	static String hindiMovies[]= {"Pathaan","Baskasuran","Ram Setu","Thank God","Dada","Shershaah","3 Idiots","Tumbbad","Runway 34",
	...
	static String teluguMovies[]= {"Fidaa","Hit","Neetho","Giri","Acharya","Puli","Oh My Darling","Sita Ramam","Custody ",
	"Maharshi","V","Nota","Black","Saaho","Paagal","Aame","F2","Mismatch","Majili","Evaru","Jai Bhim","Goodchari","Athadu","VIP2","Jannu"};
	
	static String englishMovies[]= {"After","My Fault","AIR","The Boss Baby","Smile","Fall","X","KING","Creed2",
	"Creed","Fortress","Sista","Top Gun","The Lair","Room 203","Venom","Nikita","Deep Water","Die Hart","Overdose",
	"Rocky","Shrek","King Kong","Sayen","COMA"};
	
	static String malayalamMovies[]= {"Ayisha","Kaduva","Kooman","Kotthu","Varayan","#Home","4 years","Jo&Jo","Malik","Meow","Pada",
